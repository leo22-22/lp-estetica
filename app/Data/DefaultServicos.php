...
class DefaultServicos
{
    ...
    {
        return [
            ['icone' => 'fas fa-spa',        'titulo' => 'Limpeza de Pele',    'descricao' => 'Limpeza profunda com extração, hidratação e revitalização da pele. Resultado imediato e pele renovada.',        'preco' => 'A partir de R$ 120', 'ordem' => 1],
